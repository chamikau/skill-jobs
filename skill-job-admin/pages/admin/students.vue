      ...
      <div class="page-header d-print-none">
        <div class="row g-2 align-items-center">
          <div class="col d-flex align-items-center">
            <span class="fw-bold fs-2">Students</span>
          </div>
          <div class="card">
...
<!--                    <button class="btn w-25" data-bs-toggle="tooltip" data-bs-placement="right" title="inactive"-->
...
export default {
  ...
  methods: {
    async goToViewDetails(props) {
      ...
      await this.$router.push(`/admin/student/${props.record.id}/general`)
    },
    async getStudents(page = 1, sort = '', search = '', per_page = 15,) {
      try {
        ...
        console.log(this.attributes.api_response)
