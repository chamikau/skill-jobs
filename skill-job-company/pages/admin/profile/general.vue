        ...
        <div class="row">
          <div class="col-md-6">
            <div class="mb-3">
              ...
              <input v-model="update_profile_form.fields.first_name"
                     type="text" class="form-control " :class="[update_profile_form.errors.first_name ? 'is-invalid' : '']"
            ...
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <input v-model="update_profile_form.fields.last_name"
                       type="text" class="form-control " :class="[update_profile_form.errors.last_name ? 'is-invalid' : '']"
  ...
  methods: {
    ...
    async updateProfile() {
      try {
        ...
        await this.$axios.$post('/api/company/profile', this.update_profile_form.fields)
