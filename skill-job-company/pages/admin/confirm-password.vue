  ...
  <div class="page page-center">
    <div class="container-tight py-4">
      <div class="text-center mb-4">
        <a href="profile" class="navbar-brand navbar-brand-autodark"><img src='~/assets/Logo_primary.png' height="36" alt=""></a>
      </div>
  ...
  methods: {
    async confirmPassword() {
      try {
        ...
        await this.$axios.post('user/confirm-password?portal=company', this.confirm_password_form.fields)
