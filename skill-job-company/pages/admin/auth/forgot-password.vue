  ...
  <div class="page page-center">
    <div class="container-tight py-4">
      <div class="text-center mb-4">
        Moxy- logo
<!--        <a class="navbar-brand navbar-brand-autodark" href="."><img alt="" height="36" src='~/assets/Logo_primary.png'></a>-->
      </div>
  ...
  methods: {
    ...
    async sendResetLink() {
      try {
        ...
        let response = await this.$axios.$post('forgot-password?portal=company', this.forgot_password_form.fields)
