          ...
          <div class="card card-sm">
            <div class="card-body">
              <div class="row align-items-center">
                <div class="col-auto">
                  <span class="bg-blue text-white avatar"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
...
export default {
  ...
  methods: {
    async getJobCount() {
      try {
        this.active_jobs_count = (await this.$axios.$get('/api/company/get-job-count',
        {
          params: {
            per_page: 200,
              'filter[state]': 'active',
        ...
        this.inactive_jobs_count = (await this.$axios.$get('/api/company/get-job-count',
          {
            params: {
              per_page: 200,
