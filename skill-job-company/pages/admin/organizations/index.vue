                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col">
                      ...
                      <div class="text-muted">
                        {{ firstLetterUpperCase(organization.state) }}
                      </div>
                    </div>
...
export default {
  ...
  methods: {
    async getOrganizations() {
      try {
        let organizations = (await this.$axios.$get('api/company/organizations',
          {
            params: {
              per_page: 200,
            }
    ...
    async getInvitations() {
      try {
        let invitations = (await this.$axios.$get('api/company/profile/invitations',
          {
            params: {
              per_page: 200,
              'filter[state]': 'sent',
    ...
    async acceptInvitation(id) {
      try {
        await this.$axios.$post(`api/company/profile/invitations/${id}/accept`)
