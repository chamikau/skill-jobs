    ...
    strategies: {
      cookie: {
        ...
        endpoints: {
          ...
          login: {url: process.env.API_URL + '/login?portal=company', method: 'post'},
          logout: {url: process.env.API_URL + '/logout?portal=company', method: 'post'},
          user: {url: process.env.API_URL + '/api/admin/profile?portal=company', method: 'get'}
        },
      }
    },
    redirect: {
